...
MY_CONNECTION_STRING = "DefaultEndpointsProtocol=https;AccountName=sttemperaturetestweu001;AccountKey=iCAkFc6T8XcqyP23FRaT8Nd9mjrgwVUsfxP1IpJa1CfDRnAm3SpDI68nrXFAFmd5sPk852KlNf42+AStRg8PYw==;EndpointSuffix=core.windows.net"

# Replace with blob container name
MY_BLOB_CONTAINER = "ci-temperature-test-weu-001"

# Replace with the local folder where you want downloaded files to be stored
LOCAL_BLOB_PATH = "C:\\Users\\jiri.pillar\\Downloads\\2022"
